...
void main() {
  testWidgets('rider profile tab renders without crash', (tester) async {
    final controller = await pumpSpotterRoute(tester, AppRoutes.home, overrideRole: UserRole.rider);
    
    // Switch to tab index 4 (Profile tab for Rider)
